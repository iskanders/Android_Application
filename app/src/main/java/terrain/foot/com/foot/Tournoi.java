...
public class Tournoi extends AppCompatActivity {
    TextView validd;
    String id, Email,Img;
    ImageView back,img,refrech,addph;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       back = (ImageView) findViewById(R.id.back);
        addph = (ImageView) findViewById(R.id.addphoto);
        validd=(TextView)findViewById(R.id.valider);
        publication = (EditText) findViewById(R.id.text);
